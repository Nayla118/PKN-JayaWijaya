...
export default function BudayaPage() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-primary/10 via-background to-primary/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h1 className="text-5xl sm:text-6xl font-bold mb-6">
              Budaya <span className="text-primary">Kabupaten Jayawijaya</span>
            </h1>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Kekayaan budaya Suku Dani dan masyarakat Papua yang masih terjaga hingga kini
            </p>
          </div>
        </div>
      </section>
